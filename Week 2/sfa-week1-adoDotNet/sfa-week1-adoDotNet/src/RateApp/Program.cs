...
namespace RateApp
{
    class Program
    {
        ...
        private static void AddOwner()
        {
            ...
            _restaurantService.AddOwner(restaurantId, ownerId);
        }
        ...
        private static void RenderMenu()
        {
            ...
            Console.WriteLine("8. Add restaurant owner");
        }
        ...
        private static void DisplayReviews(List<Review> reviews)
        {
            if (reviews.Any())
            {
                foreach (Review review in reviews)
                {
                    ...
                    Console.WriteLine("Rating: {0}", new string('*', review.Rating));
                    Console.WriteLine("==========================================");
                }
            }
            else
        ...
        private static void WriteReview()
        {
            ...
            if (int.TryParse(stringId, out id))
            {
                ...
                if (restaurant != null)
                {
                    ...
                    _restaurantService.AddReview(restaurant, _userService.CurrentUser, text, rating);
        ...
        private static void ListRestaurants()
        {
            ...
            if (restaurants.Any())
            {
                foreach (Restaurant restaurant in restaurants)
                {
                    ...
                    Console.WriteLine("OwnedBy: " + string.Join(", ", restaurant.Owners.Select(o => o.Name)));
                    Console.WriteLine("=======================================================");
                }
            }
            else
